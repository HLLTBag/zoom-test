...
const prefix = path.resolve(__dirname, '../../node_modules/electron/dist/Electron.app/Contents/Resources/app/node_modules');
$.import(path.resolve(prefix,'ZoomSDK/util.framework'));
$.import(path.resolve(prefix,'ZoomSDK/ZCommonUI.framework'));
$.import(path.resolve(prefix,'ZoomSDK/cmmlib.framework'));
$.import(path.resolve(prefix,'ZoomSDK/ZoomSDKChatUI.framework'));
$.import(path.resolve(prefix,'ZoomSDK/ZoomSDK.framework'));
